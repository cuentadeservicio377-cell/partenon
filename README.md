...
- `data/sample_gastos.xlsx` — workbook with Dashboard, Income, Fixed Expenses, Variable Expenses, and Vendors sheets.
- `data/sample_gastos_report.json` — income, fixed expenses, variable expenses, margin, and alerts.
