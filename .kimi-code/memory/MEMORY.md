...
- **Hackathon video**: `partenon-hackathon-video.mp4` — 2:28 English explainer produced with Hermes `manim-video` skill, Manim CE, ffmpeg, and macOS TTS. Plan/script in `video/partenon-hackathon/`.
