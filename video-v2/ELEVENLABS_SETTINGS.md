# ElevenLabs Settings — Partenon Video v2

Use these exact settings. Paste the script block into the ElevenLabs text box.
...
Paste this entire block, including the `<speak>` tags:
...
<speak>
  <prosody rate="95%" pitch="-2%">
    ...
    <p>
      ...
      <s>Receipts.<break time="300ms"/> Invoices.<break time="300ms"/> Follow-ups.</s>
    </p>
    <p>
      <s>We built a home for Hermes inside the business.</s>
      <s>The Partenon.</s>
      <s>Seven profiles.<break time="300ms"/> One shared memory.</s>
    </p>
    <p>
      <s>The Scribe reads the receipts.</s>
    ...
    <p>
      ...
      <s>Live runs out of the box.</s>
      <s>Connect needs your credentials.</s>
      <s>Roadmap is labeled clearly.</s>
      <s>No surprises.</s>
    </p>
    <p>
      <s>You install it.</s>
    ...
    <p>
      <s>The goal is one million installations.</s>
      <s>Because every install is one more founder spending time on product, customers, and growth.</s>
    </p>
    <p>
      <s>Hermes is the agent.</s>
      <s>The Partenon is the home.</s>
      <s>Open source must win.</s>
    </p>
  </prosody>
</speak>
```
...
- **Place in:** `video-v2/assets/voice/`

## Target duration

Aim for roughly **75–85 seconds** total. If it comes out much shorter, increase the `<break time="..."/>` values slightly.
