...
- [ ] Run `python3 scripts/demo_tesorero.py` and verify the report.
...
- [ ] Copy the profile templates you need:
  - `.finance` from `hermes/profiles/partenon-tesorero/templates/.finance.example`
  - `.design` from `hermes/profiles/partenon-mensajero/templates/.design.example`
  - `.payments` from `hermes/profiles/partenon-cobrador/templates/.payments.example`
  - `.security` from `hermes/profiles/partenon-guardian/templates/.security.example`
  - `.ops` from `hermes/profiles/partenon-estratega/templates/.ops.example`
  - `.relations` from `hermes/profiles/partenon-diplomatico/templates/.relations.example`
